...
**`main` is at `v0.35.0`; the NAS is running `v0.34.0`** and needs the deploy
below. 241 unit, 607 integration and 179 end-to-end tests. There is no CI: GitHub stores the code and nothing else
