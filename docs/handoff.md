...
**`main` is at `v0.34.0`; the NAS is running `v0.32.0`** and needs the deploy
below. 234 unit, 607 integration and 175 end-to-end tests. There is no CI: GitHub stores the code and nothing else
